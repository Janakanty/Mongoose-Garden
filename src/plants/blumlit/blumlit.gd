...
func _on_progres_value_changed(value):
	...
	if progres_bar.max_value == value:
		if plant_condition == 1:
			...
			plant_level = 1
		elif plant_level == 1 and blumlit_added_condition == 0:
			blumlit_added_condition = 1
		elif plant_level == 1 and blumlit_added_condition == 1:
			blumlit_added_condition = 2
		elif plant_level == 1 and blumlit_added_condition == 2:
			plant_level = 2
		progres_bar.value = 0
		check_plant_condition()
